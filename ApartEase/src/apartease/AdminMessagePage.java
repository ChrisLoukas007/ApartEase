 ...
 * @author DELL
 */
public class AdminMessagePage extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminMessagePage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
